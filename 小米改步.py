...
if __name__ == "__main__":
    ...
    step_array = ['29000', '35000']  # 随机步数 20000到30000步的范围取值
    user_list = ['176****956', '账号二']  # 账号，如果还有可以进行添加，以 ,'账号三' 的形式，以下密码也是
    passwd_list = ['***456', '账号二密码']  # 密码
