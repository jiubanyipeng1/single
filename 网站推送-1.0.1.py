...
baidu_api = "http://data.zz.baidu.com/urls?site=https://www.jiubanyipeng.com&token=你的"  # 百度AIP
sm_api = "https://data.zhanzhang.sm.cn/push?site=你的&user_name=你的&resource_name=mip_add&token=你的"  # 神马API
push_url = get_urllist(sitemap_url)['data']  # 如果不适配，这里修改成列表，如：push_url=['网址1','网址2']，如果你的很多可以放到文本里面自己通过读写操作，变成列表
